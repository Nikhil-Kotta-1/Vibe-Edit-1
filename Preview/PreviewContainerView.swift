...
struct PreviewContainerView: View {
    ...
    var body: some View {
        ...
        .overlay(alignment: .top) { VoiceStatusView() }
    }
        ...
        ZStack {
            ...
            VStack(spacing: AppTheme.Spacing.md) {
                ...
                Text(isUnprocessable
                    ? "VibeEdit loaded this clip's source file but couldn't prepare it for playback. The file may be corrupt or in an unsupported format."
                    : "VibeEdit couldn't load this clip's source file. It may be missing, on an ejected drive, or unreadable.")
                    .font(.system(size: AppTheme.FontSize.sm))
                    .foregroundStyle(AppTheme.Text.secondaryColor)
