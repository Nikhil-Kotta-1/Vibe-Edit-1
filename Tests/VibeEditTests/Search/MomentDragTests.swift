...
struct MomentDragTests {
    ...
    @Test func malformedSegmentsRejected() {
        #expect(MediaTab.assetSegment(fromDragString: "vibeedit-asset://x#5-2") == nil)
        #expect(MediaTab.assetSegment(fromDragString: "vibeedit-asset://x#-1-2") == nil)
        #expect(MediaTab.assetSegment(fromDragString: "vibeedit-asset://x#junk") == nil)
        #expect(MediaTab.assetSegment(fromDragString: "vibeedit-folder://x#1-2") == nil)
        #expect(MediaTab.assetId(fromDragString: "vibeedit-asset://x#junk") == "x")
    }
