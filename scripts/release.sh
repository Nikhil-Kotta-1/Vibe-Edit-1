...
PLIST="$ROOT/Sources/VibeEdit/Resources/Info.plist"
...
NOTES_CLEAN="$(mktemp -t vibeedit-release.XXXXXX).md"
...
BUILD_LOG="$(mktemp -t vibeedit-build.XXXXXX).log"
...
url = f"https://github.com/adhvaidhsunny/VibeEditor/releases/download/v{v}/VibeEdit.dmg"
...
echo ""
echo "==> Released $TAG"
echo "    https://github.com/adhvaidhsunny/VibeEditor/releases/tag/$TAG"
